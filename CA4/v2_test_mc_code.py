...
from mc_code_dict import read_file, get_commits, get_authors #linking the other program 


class TestCommits(unittest.TestCase): #creating a oject - to test the code in other program
